...
const PortfolioCard = ({ id, image, title, createdAt, description, technologies, demoLink, githubLink, onEdit, onDelete }) => {
  ...
  return (
    <div onClick={handleCardClick} className="bg-gray-100 rounded-lg shadow-md hover:shadow-lg p-4 w-full relative transition-transform transform hover:scale-105 cursor-pointer">
